...
public class DarkstoneEntity extends Entity implements ItemSupplier {
    ...
    public DarkstoneEntity(EntityType<? extends DarkstoneEntity> pEntityType, Level level) {
        super(pEntityType, level);
    }

    public DarkstoneEntity(Level level, double pX, double pY, double pZ) {
        this(ModEntities.DARKSTONE_ENTITY.get(), level);
    ...
    public ItemStack getItem() {
        ...
        return itemstack.isEmpty() ? new ItemStack(ModItems.DARKSTONE.get()) : itemstack;
    }
            ...
            if (distanceSq < 0.01D && life>80) {
                ...
                if (this.level() instanceof ServerLevel serverLevel) {
                    serverLevel.getServer().getCommands().performPrefixedCommand(
                            ...
                            "pokespawn zekrom "+" "+this.getX()+" "+this.getY()+" "+this.getZ()
                    );
                }
            }
        } else {
